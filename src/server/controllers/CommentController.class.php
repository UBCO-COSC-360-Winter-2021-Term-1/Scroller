...
class CommentController extends Controller {
	...
	public function loadCommentsByPostId(int $id) : array {
		...
		WHERE comments.is_deleted = 0 AND comments.post_id = $id GROUP BY comments.comment_id ORDER BY numOfVotes DESC";
