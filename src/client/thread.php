  	...
  	<div class="row">
			...
			<div class="col-md-6 topic-threads overflow-auto mx-auto mb-4">
				...
				<?php 
					...
					$sortedPosts = (new PostController())->loadPostByThread([$url[1], 'Top']);
