	...
	<div class="row">
		<div class="col-md-6 bg-white">
			<div class="recover-container p-4 py-3 mt-5 mx-auto w-100">
				...
				<h4 class="mb-5">Let's Get Access To Your Account</h4>

				<form method="POST">
					<div class="mb-4 inputs">
						<label for="codeInput" class="form-label text-uppercase">Email</label>
						<input type="email" id="emailConfirmRecoverInput" required placeholder="john@scroller.ca">
					</div>
					<div class="btn-container text-uppercase d-flex justify-content-between mt-5 mb-4 w-50">
						
						<button type="submit" class="recover-confirm">Recover</button>
					</div>
				</form>
